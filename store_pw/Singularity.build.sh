...
case $1 in
  1)  # To build new copy from local recipe file:
      #   sudo singularity build ubuntu_base.simg ./Singularity.base-4.2.5
      #
      # To pull from auto build at Singularity Hub: (http://singularity-hub.org):
